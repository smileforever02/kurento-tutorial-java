                    ...
                    action: function(dialog) {
                        ...
                        if(file){
                            Services.uploadPhoto(file)
                                .done(() => MessageBox.success('Upload successfully.'))
